...
public class Message {
  ...
  /**
   * JSON Message constructor Creates a Message from its JSON representation
   *
   ...
   *
   * @return a String representation of the message containing sender, timestamp, and message text
   */
  @Override
